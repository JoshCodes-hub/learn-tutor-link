...
export function OfflineBanner() {
  ...
  return (
    <div className="fixed top-[env(safe-area-inset-top)] inset-x-0 z-[200] bg-amber-500/95 text-amber-950 text-xs py-2 px-4 flex items-center justify-center gap-2 shadow-md backdrop-blur">
